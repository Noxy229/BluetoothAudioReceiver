    ...
    private Dictionary<string, string>? LoadTranslation(string languageCode)
    {
        return languageCode switch
        {
            "en" => new Dictionary<string, string>
            {
                ...
                ["OpenWindowsSettings"] = "Pair your phone in Windows settings",
                ["Connect"] = "Connect",
            ...
            "de" => new Dictionary<string, string>
            {
                ...
                ["OpenWindowsSettings"] = "Kopple dein Handy in den Windows-Einstellungen",
                ["Connect"] = "Verbinden",
                ["Disconnect"] = "Trennen",
            ...
            "es" => new Dictionary<string, string>
            {
                ...
                ["Refresh"] = "Actualizar",
                ["NoDevicesTitle"] = "No se encontraron dispositivos.",
                ["OpenWindowsSettings"] = "Empareja tu teléfono en la configuración de Windows",
                ["Connect"] = "Conectar",
            ...
            "fr" => new Dictionary<string, string>
            {
                ...
                ["Devices"] = "APPAREILS",
                ["Refresh"] = "Actualiser",
                ["NoDevicesTitle"] = "Aucun appareil trouvé.",
                ["OpenWindowsSettings"] = "Associez votre téléphone dans les paramètres Windows",
                ["Connect"] = "Connecter",
